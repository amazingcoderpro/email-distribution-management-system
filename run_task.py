...
def run():
    ...
    tp.create_cron_task(ems.update_customer_group_data, "*", 0, 1)  # 每天23:50:0更新到目前时间用户组最新ems数据
    tp.create_cron_task(ems.update_email_reocrd_data, "*", 0, 1)  # 每天23:50:0更新到目前时间已发送邮件最新ems数据
    tp.create_cron_task(ems.insert_dashboard_data, "*", 0, 1)  # 每天23:50:0更新dashboard最新数据
