    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('letter_domain', models.CharField(blank=True, max_length=255, null=True, verbose_name='letter_domain')),
                ('news_domain', models.CharField(blank=True, max_length=255, null=True, verbose_name='news_domain')),
                ('message_domain', models.CharField(blank=True, max_length=255, null=True, verbose_name='message_domain')),
                ('customer_shop', models.CharField(blank=True, max_length=255, null=True, verbose_name='customer_shop')),
                ('customer_email', models.CharField(blank=True, max_length=255, null=True, verbose_name='customer_email')),
