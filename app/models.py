...
class EmailTemplate(models.Model):
    ...
    subject = models.TextField(blank=True, null=True, verbose_name="邮件标题")
    heading_text = models.TextField(blank=True, null=True, verbose_name="邮件")
...
class EmailRecord(models.Model):
    ...
    recipients = models.TextField(blank=True, null=True, default="{}", verbose_name="收件人信息字典")
    if ENABLE_MIGRATE:
        store_id = models.IntegerField(db_index=True, verbose_name="店铺id")
    else:
        store = models.ForeignKey(Store, on_delete=models.DO_NOTHING)
...
class EmailTask(models.Model):
    ...
    if ENABLE_MIGRATE:
        template_id = models.IntegerField(db_index=True, null=True, blank=True, default=None,
                                          verbose_name="email_template_id")
