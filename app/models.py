...
class Dashboard(models.Model):
    ...
    total_sessions = models.IntegerField(default=0, verbose_name="sessions总量")
    session = models.IntegerField(default=0, verbose_name="session")
    avg_repeat_purchase_rate = models.FloatField(default=0,  verbose_name="Repeat Purchase Rate")
    avg_conversion_rate = models.FloatField(default=0,  verbose_name="Conversion Rate")
    total_sent = models.IntegerField(default=0, verbose_name="Sent总量")
    total_open = models.IntegerField(default=0,  verbose_name="Open总量")
    total_click = models.IntegerField(default=0,  verbose_name="Click总量")
    total_unsubscribe = models.IntegerField(default=0,  verbose_name="Unsubscribe总量")
    avg_open_rate = models.FloatField(default=0,  verbose_name="Open Rate")
    avg_click_rate = models.FloatField(default=0,  verbose_name="Click Rate")
    avg_unsubscribe_rate = models.FloatField(default=0,  verbose_name="Unsubscribe Rate")
    if ENABLE_MIGRATE:
